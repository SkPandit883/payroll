                                    ...
                                    <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                        ...
                                        <li class="nav-item">
                                            ...
                                            <ul role="menu" class="dropdown-header-top author-log dropdown-menu animated zoomIn">
                                                <li>
                                                    <a href="#" data-modal-toggle="profile-modal"><span class="edu-icon edu-home-admin author-log-ic"></span>My Account</a>
                                                </li> 
                                                <li>
                                                    <a href="#" data-modal-toggle="password-change-modal" ><span class="edu-icon edu-home-admin author-log-ic"></span>Change Password</a>
                                                </li>
                                                <li>
