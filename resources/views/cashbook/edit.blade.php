@extends('assets.master',['breadcrumbs'=>'CashBook'])
                                        ...
                                        <form action="{{route('CashBook.update',$CashBook->id)}}" method="POST">
                                            ...
                                            <div class="form-group-inner">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                        <input required name="date" type="date" class="form-control" value="{{$CashBook->date}}" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group-inner">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                        <input required name="bill_no" type="text" class="form-control" value="{{$CashBook->bill_no}}" />
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group-inner">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                        <input min="0" name="amount" type="number" class="form-control" value="{{$CashBook->amount}}"/>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group-inner">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                        <input required name="remarks" type="text" class="form-control" value="{{$CashBook->remarks}}"/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group-inner">
